...
<head>
    ...
    <title>Wachtwoord Herstellen - The Hair Hub</title>
    <!-- Bootstrap CSS -->
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/klanten') }}">Inloggen</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <div class="reset-password-container">
            <h2 class="section-title">Wachtwoord Herstellen</h2>
            
            <p class="mb-4">Voer je e-mailadres en nieuwe wachtwoord in om je wachtwoord te herstellen.</p>
            
            <form method="POST" action="{{ route('klant.password.store') }}">
                @csrf
